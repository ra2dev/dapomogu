...
function Footer() {
  return (
    <footer className="flex justify-center align-middle">
      <div className="ml-auto max-w-6xl mx-auto px-4 sm:px-6">
        {/* Top area: Blocks */}
        <div className="grid sm:grid-cols-9 gap-8 py-8 md:py-12 border-t border-gray-200">
          {/* 1st block */}
          {/* 2nd block */}
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">Made by ..</div>
        </div>
      </div>
    </footer>
  );
